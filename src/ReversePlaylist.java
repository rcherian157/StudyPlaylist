...
/**
 * Song iterator that goes through the songs from end to front
 * 
 * @author rheacherian
 *
 */
public class ReversePlaylist implements Iterator<Song> {
  ...
  /**
   * Constructor that initializes the tail node of a doubly linked playlist
   * 
   * @param tail - tail node of a doubly linked list
   */
  ...
  public Song next() {
    ...
    // update current song to the previous song
